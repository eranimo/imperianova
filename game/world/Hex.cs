...
namespace Hex {
	...
	public class HexUtils {
		...
		public static Dictionary<SidePoint, Vector3> GetHexSidePoints(Direction dir) {
			...
			var C4 = C3.LinearInterpolate(center, 0.5f);
			var S1 = c1_points[CornerPoint.B].LinearInterpolate(C2, 0.5f);
			var S2 = c2_points[CornerPoint.B].LinearInterpolate(C2, 0.5f);
			...
			results.Add(SidePoint.S1, S1);
			results.Add(SidePoint.S2, S2);
